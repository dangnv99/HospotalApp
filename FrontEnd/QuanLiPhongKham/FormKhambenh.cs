    ...
    public partial class FormKhambenh : Form
    {
        ...
        public void LoadSchedule()
        {
            ...
            try
            {
                ...
                gcLichKham.DataSource = Schedule.data;
            }
            catch (Exception ex)
            {
                Inventec.Common.Logging.LogSystem.Error(ex);
        ...
        private void gvLichKham_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
        ...
        private void gvLichKham_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            try
            {
        ...
        private void btnSave_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    responUserRole getrolePatient_ = new responUserRole();
                    getrolePatient_.data = getrolePatient.data.Where(o => o.id == row.patientId).ToList();
                    update.name = getrolePatient_.data.FirstOrDefault().name;
                    update.address = getrolePatient_.data.FirstOrDefault().address;
                    update.phone = getrolePatient_.data.FirstOrDefault().phone;
                    update.job = getrolePatient_.data.FirstOrDefault().job;
                    update.note1 = txtNote1.Text;
